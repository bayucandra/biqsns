...
<title>biq-wp-sns: normalize-package-data [![Build Status](https://travis-ci.org/npm/normalize-package-data.png?branch=master)](https://travis-ci.org/npm/normalize-package-data)</title>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_gulp-src_node_modules_gulp-concat_node_modules_gulp-util_node_modules_dateformat_node_modulesf792fa6929bf04065590b959dace2bf9.html','');});
</script>
<div id="doc-content">
...
<h2>Installation</h2>
<p>``` npm install normalize-package-data ```</p>
<h2>Usage</h2>
...
<p>```javascript normalizeData = require('normalize-package-data') packageData = fs.readFileSync("package.json") normalizeData(packageData) // packageData is now normalized ```</p>
<h4>Strict mode</h4>
<p>You may activate strict validation by passing true as the second argument.</p>
<p>```javascript normalizeData = require('normalize-package-data') packageData = fs.readFileSync("package.json") warnFn = function(msg) { console.error(msg) } normalizeData(packageData, true) // packageData is now normalized ```</p>
...
<p>```javascript normalizeData = require('normalize-package-data') packageData = fs.readFileSync("package.json") warnFn = function(msg) { console.error(msg) } normalizeData(packageData, warnFn) // packageData is now normalized. Any number of warnings may have been logged. ```</p>
...
<h2>License</h2>
<p>normalize-package-data is released under the <a href="http://opensource.org/licenses/MIT">BSD 2-Clause License</a>. Copyright (c) 2013 Meryn Stol </p>
</div></div><!-- contents -->
</div><!-- doc-content -->
<!-- start footer part -->
