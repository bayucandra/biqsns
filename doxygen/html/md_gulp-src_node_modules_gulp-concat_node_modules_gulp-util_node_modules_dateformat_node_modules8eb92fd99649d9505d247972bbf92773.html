...
<title>biq-wp-sns: read-pkg-up [![Build Status](https://travis-ci.org/sindresorhus/read-pkg-up.svg?branch=master)](https://travis-ci.org/sindresorhus/read-pkg-up)</title>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_gulp-src_node_modules_gulp-concat_node_modules_gulp-util_node_modules_dateformat_node_modules8eb92fd99649d9505d247972bbf92773.html','');});
</script>
<div id="doc-content">
...
<h2>Install</h2>
<p>``` $ npm install &ndash;save read-pkg-up ```</p>
<h2>Usage</h2>
<p>```js var readPkgUp = require('read-pkg-up');</p>
<p>readPkgUp().then(function (result) { console.log(result); /* { pkg: { name: 'awesome-package', version: '1.0.0', ... }, path: '/Users/sindresorhus/dev/awesome-package' } */ }); ```</p>
<h2>API</h2>
