...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_gulp-src_node_modules_gulp-uglify_node_modules_gulp-util_node_modules_dateformat_node_modulesbd05af59b1ebb3811bac4027cc1ce5d1.html','');});
</script>
<div id="doc-content">
...
<p><a href="https://travis-ci.org/floatdrop/pinkie">![Build Status](https://travis-ci.org/floatdrop/pinkie.svg?branch=master)</a> <a href="https://coveralls.io/github/floatdrop/pinkie?branch=master">![Coverage Status](https://coveralls.io/repos/floatdrop/pinkie/badge.svg?branch=master&amp;service=github)</a></p>
...
<h2>Install</h2>
<p>``` $ npm install &ndash;save pinkie ```</p>
<h2>Usage</h2>
<p>```js var fs = require('fs'); var Promise = require('pinkie');</p>
<p>new Promise(function (resolve, reject) { fs.readFile('foo.json', 'utf8', function (err, data) { if (err) { reject(err); return; }</p>
<p>resolve(data); }); }); //=&gt; Promise ```</p>
<h3>API</h3>
