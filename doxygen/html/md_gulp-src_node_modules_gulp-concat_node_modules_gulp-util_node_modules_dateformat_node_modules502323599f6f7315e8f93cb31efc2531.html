...
<title>biq-wp-sns: read-pkg [![Build Status](https://travis-ci.org/sindresorhus/read-pkg.svg?branch=master)](https://travis-ci.org/sindresorhus/read-pkg)</title>
...
<script type="text/javascript">
$(document).ready(function(){initNavTree('md_gulp-src_node_modules_gulp-concat_node_modules_gulp-util_node_modules_dateformat_node_modules502323599f6f7315e8f93cb31efc2531.html','');});
</script>
<div id="doc-content">
...
<h2>Install</h2>
<p>``` $ npm install &ndash;save read-pkg ```</p>
<h2>Usage</h2>
<p>```js var readPkg = require('read-pkg');</p>
<p>readPkg().then(function (pkg) { console.log(pkg); //=&gt; {name: 'read-pkg', ...} });</p>
<p>readPkg(__dirname).then(function (pkg) { console.log(pkg); //=&gt; {name: 'read-pkg', ...} });</p>
<p>readPkg(path.join('unicorn', 'package.json')).then(function (pkg) { console.log(pkg); //=&gt; {name: 'read-pkg', ...} }); ```</p>
<h2>API</h2>
