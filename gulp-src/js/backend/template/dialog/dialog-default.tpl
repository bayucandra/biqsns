<div style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; background-color: rgba(255,255,255,0.7); z-index:100;">
    ...
    <style>
        ...
        <a href='https://github.com/keyframes' class='user-mention'>@keyframes</a> f_fadeG {
            0% {
